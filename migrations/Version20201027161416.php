 ...
 */
final class Version20201027161416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id INT NOT NULL, ADD user_id INT NOT NULL, DROP post_id_id, DROP user_id_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id_id INT NOT NULL, ADD user_id_id INT NOT NULL, DROP post_id, DROP user_id');
